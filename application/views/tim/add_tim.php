      ...
      <div class="container">
        <div class="slim-pageheader">
          <ol class="breadcrumb slim-breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Tim Rikkes</li>
          </ol>
          <h6 class="slim-pagetitle">Tambah Tim Rikkes</h6>
        </div><!-- slim-pageheader -->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-3">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="preview_gambar" name="foto_tim">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-4">
                <div class="form-group mg-md-l--1 bd-t-0-force">
                  <label class="form-control-label">NRP: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="nrp" placeholder="">
                </div>
              </div><!-- col-8 -->
              <div class="col-md-4">
                <div class="form-group mg-md-l--1 bd-t-0-force">
                  <label class="form-control-label">Korps: <span class="tx-danger">*</span></label>
              ...
              <div class="col-md-4">
                <div class="form-group mg-md-l--1 bd-t-0-force">
                  <label class="form-control-label">Kesatuan: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="kesatuan" placeholder="">
                </div>
              </div><!-- col-8 -->
              <div class="col-md-4">
                <div class="form-group mg-md-l--1 bd-t-0-force">
                  <label class="form-control-label">Matra: <span class="tx-danger">*</span></label>
