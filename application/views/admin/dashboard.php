        ...
        <div class="row row-sm mg-t-20">
            ...
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="<?php echo base_url($this->config->item("theme_admin")."/img/icon1.svg"); ?>" class="wd-100" alt="">
                </div>
          ...
          <div class="col-lg-4 mg-t-20 mg-lg-t-0">
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="<?php echo base_url($this->config->item("theme_admin")."/img/icon2.svg"); ?>" class="wd-100" alt="">
                </div>
